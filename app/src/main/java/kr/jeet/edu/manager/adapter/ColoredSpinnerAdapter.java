...
//public class ColoredSpinnerAdapter extends RecyclerView.Adapter<ColoredSpinnerAdapter.ViewHolder> implements PowerSpinnerInterface<SpannableString> {
...
//    Context _context;
//    public ColoredSpinnerAdapter(Context context, List<SpannableString> list){
...
public class ColoredSpinnerAdapter extends RecyclerView.Adapter<ColoredSpinnerAdapter.CustomSpinnerViewHolder> implements PowerSpinnerInterface<SpannableString> {
    private static final int NO_SELECTED_INDEX = -1;
    private int index = NO_SELECTED_INDEX;
    private PowerSpinnerView spinnerView;
    private OnSpinnerItemSelectedListener<SpannableString> onSpinnerItemSelectedListener;
    ...
    public ColoredSpinnerAdapter(Context mContext, List<SpannableString> mList, PowerSpinnerView spinnerView){
