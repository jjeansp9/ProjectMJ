...
public class SelectReportCardRecipientActivity extends BaseActivity implements MonthPickerDialog.OnDateSetListener{
    private static final String TAG = "reportcard_edit";
